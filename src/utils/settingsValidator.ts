...
class SettingsValidator {
  ...
  private validateStructure(settings: any, errors: ValidationError[]): boolean {
    if (!settings) {
      errors.push({
        path: '',
  ...
  private validateCalculatorConfig(config: any, errors: ValidationError[]): void {
  ...
  private validateUIPreferences(preferences: any, errors: ValidationError[]): void {
  ...
  private validateSyncConfig(config: any, errors: ValidationError[]): void {
...
export const settingsValidator = SettingsValidator.getInstance(); 