...
exports.performanceOptimizationAdvisor = void 0;
const performanceWarningSystem_1 = require("./performanceWarningSystem");
class PerformanceOptimizationAdvisor {
    ...
    generateSuggestions(metrics) {
        const suggestions = [];
        const warnings = performanceWarningSystem_1.performanceWarningSystem.getWarnings();
        // 检查计算性能
    ...
    sortSuggestionsByPriority(suggestions) {
        return [...suggestions].sort((a, b) => this.getPriorityOrder(a.priority) - this.getPriorityOrder(b.priority));
    }
}
exports.performanceOptimizationAdvisor = PerformanceOptimizationAdvisor.getInstance();
