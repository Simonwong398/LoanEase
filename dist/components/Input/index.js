...
exports.Input = React.forwardRef((_a, ref) => {
    var { label, error, size = 'medium', fullWidth = false, startAdornment, endAdornment, disabled = false, className = '' } = _a, props = __rest(_a, ["label", "error", "size", "fullWidth", "startAdornment", "endAdornment", "disabled", "className"]);
    return (<div className={`input-wrapper ${fullWidth ? 'full-width' : ''} ${className}`}>
